...
In order to install the plugin, simply run: `bin/plugin -install elasticsearch/elasticsearch-cloud-gce/1.3.0`.
...
|----------------------------|---------------------|--------------|:------------:|
| 1.4.0-SNAPSHOT             | 0.90.3 -> 0.90      |  1.18.0-rc   |  XXXX-XX-XX  |
| 1.3.0                      | 0.90.3 -> 0.90      |  1.18.0-rc   |  2014-04-16  |
...
* [1.4.0-SNAPSHOT](https://github.com/elasticsearch/elasticsearch-cloud-gce/blob/es-0.90/README.md)
* [1.3.0](https://github.com/elasticsearch/elasticsearch-cloud-gce/blob/v1.3.0/README.md)
...
sudo /usr/share/elasticsearch/bin/plugin \
     --install elasticsearch/elasticsearch-cloud-gce/1.2.0
...
gcutil --project=es-cloud addimage elasticsearch-0-90-10 \
...
gcutil --project=es-cloud addinstance --image=elasticsearch-0-90-10 \
