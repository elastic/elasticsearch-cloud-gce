...
```
Failing to set this will result in unauthorized messages when starting Elasticsearch. There's more information in the notes at the bottom of the page.
